...
var WordLollipop = /** @class */ (function (_super) {
    ...
    WordLollipop.prototype.createWords = function () {
        var words = {};
        this.data.texts.map(function (value) { return value.match(/[a-z0-9']+/g); }).forEach(function (value) {
            if (value) {
        ...
        }).sort(function (a, b) { return b.size - a.size; }).slice(0, this.data.top);
    };
    ...
    WordLollipop.prototype.setTop = function (top) {
        this.data.top = top;
    };
    return WordLollipop;
...
var WordLollipopOptions = /** @class */ (function (_super) {
    ...
    WordLollipopOptions.prototype.options = function () {
        return [
            new data_science_lab_core_1.NumberOption({ id: 'top', label: 'Show only the top X number of occurances (Enter for X).', min: 1 })
        ];
    };
